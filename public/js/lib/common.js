...
define([
    ...
    $.urlParam = function(name) {
        ...
        return !_.isNull(results) ? results[1] || null : null;
    };

    $.fn.removeClassPattern = function(pattern) {
    ...
    Date.prototype.getDayOfYear = function() {
        ...
        var date1 = new Date(year, 0, 1, 12, 0, 0); // noon on Jan. 1
    ...
    Number.prototype.toAlpha = function() {
        ...
        while (num > 0) {
            num--;
            string = String.fromCharCode(97 + (num % 26)) + string;
