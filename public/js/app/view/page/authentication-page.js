...
define([
    ...
    return Page.extend({
        ...
        initialize: function () {
            ...
            this.roleCollection = app.collections.get('role');
        },
        ...
        loadCollections: function () {
            ...
            promises.push(this.roleCollection.fetch({data: {range: '0-1000'}}));
        ...
        buildListItem: function (userRole) {
            var role = userRole.find('role'),
                entity = userRole.find('entity');

            return new ListItem({
                content: new Button({
                    label: new Label({
                        text: entity.getDisplayName() + ' - ' + (_.isNull(role) ? 'admin' : role.getDisplayName()),
